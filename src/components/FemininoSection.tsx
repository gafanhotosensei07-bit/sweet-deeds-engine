...
const femininoProducts: CheckoutProduct[] = [
  {
    ...
    price: '289,90',
    installments: '26,35',
    image: 'https://static.netshoes.com.br/produtos/imagens/122/NKN-122-0001/NKN-122-0001_zoom1.jpg',
    discount: '-52%',
  },
  {
    id: 602,
    name: 'NIKE AIR MAX 270 FEMININO ROSA',
    oldPrice: '649,90',
    price: '319,90',
    installments: '29,08',
    image: 'https://static.netshoes.com.br/produtos/imagens/166/NKN-166-0001/NKN-166-0001_zoom1.jpg',
    discount: '-51%',
  },
  {
    id: 603,
    name: 'ADIDAS STAN SMITH FEMININO BRANCO',
    oldPrice: '499,90',
    price: '249,90',
    installments: '22,71',
    image: 'https://http2.mlstatic.com/D_NQ_NP_896010-MLA74764067195_022024-O.webp',
    discount: '-50%',
  },
  {
    id: 604,
    ...
    price: '199,90',
    installments: '18,17',
    image: 'https://http2.mlstatic.com/D_NQ_NP_645978-MLA74528398540_022024-O.webp',
    discount: '-50%',
  },
  {
    id: 605,
    name: 'NEW BALANCE 574 FEMININO CINZA',
    oldPrice: '549,90',
    price: '269,90',
    installments: '24,53',
    image: 'https://http2.mlstatic.com/D_NQ_NP_641534-MLA74236741267_012024-O.webp',
    discount: '-51%',
  },
  {
    id: 606,
    name: 'NIKE COURT VISION LO FEMININO',
    oldPrice: '449,90',
    price: '219,90',
    installments: '19,99',
    image: 'https://http2.mlstatic.com/D_NQ_NP_611801-MLA71502617060_092023-O.webp',
    discount: '-51%',
  },
  {
    id: 607,
    name: 'ADIDAS CAMPUS 00S FEMININO',
    oldPrice: '649,90',
    price: '299,90',
    installments: '27,26',
    image: 'https://http2.mlstatic.com/D_NQ_NP_782175-MLA74861940046_022024-O.webp',
    discount: '-54%',
  },
  {
    id: 608,
    name: 'CONVERSE ALL STAR CHUCK TAYLOR FEMININO',
    oldPrice: '349,90',
    price: '179,90',
    installments: '16,35',
    image: 'https://http2.mlstatic.com/D_NQ_NP_641422-MLA74230534561_012024-O.webp',
    discount: '-49%',
  },
];
            ...
            {femininoProducts.map((product) => (
              ...
              >
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <p className="text-[10px] text-gray-500 mb-3">12x R$ {product.installments}</p>
