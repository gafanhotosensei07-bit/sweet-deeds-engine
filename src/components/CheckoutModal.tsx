          ...
          {step === 'pix' && (
            <div className="flex flex-col items-center py-8 px-8 text-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full bg-[#25d366] text-white py-3 font-black text-sm uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-[#1da851] transition-colors mb-3"
              >
